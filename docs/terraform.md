...
| <a name="input_allowed_aws_services"></a> [allowed\_aws\_services](#input\_allowed\_aws\_services) | List of AWS services to grant access to the Elasticsearch domain | `list(string)` | `[]` | no |
...
=======
| <a name="input_allowed_iam_role_arns"></a> [allowed\_iam\_role\_arns](#input\_allowed\_iam\_role\_arns) | List of IAM role ARNs to permit access to the Elasticsearch domain | `list(string)` | `[]` | no |
| <a name="input_attributes"></a> [attributes](#input\_attributes) | Additional attributes (e.g. `1`) | `list(string)` | `[]` | no |
>>>>>>> a15664b (updated module to include accepted AWS ervices as part of the access policy)
...
| <a name="input_elasticsearch_domain_name"></a> [elasticsearch\_domain\_name](#input\_elasticsearch\_domain\_name) | Name of the domain | `string` | `""` | no |
